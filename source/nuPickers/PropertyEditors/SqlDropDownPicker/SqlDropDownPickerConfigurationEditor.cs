...
{
    internal class SqlDropDownPickerConfigurationEditor : ConfigurationEditor<SqlDropDownPickerConfiguration>
    {
        public override Dictionary<string, object> ToConfigurationEditor(SqlDropDownPickerConfiguration configuration)
        {
        ...
        private class ItemValue
        {
          ...
          public override SqlDropDownPickerConfiguration FromConfigurationEditor(IDictionary<string, object> editorValues, SqlDropDownPickerConfiguration configuration)
        {
            var output = new SqlDropDownPickerConfiguration();
