...
{
    internal class JsonPrefetchListPickerConfigurationEditor : ConfigurationEditor<JsonPrefetchListPickerConfiguration>
    {
        public override Dictionary<string, object> ToConfigurationEditor(JsonPrefetchListPickerConfiguration configuration)
        {
        ...
        private class ItemValue
        {
          ...
          public override JsonPrefetchListPickerConfiguration FromConfigurationEditor(IDictionary<string, object> editorValues, JsonPrefetchListPickerConfiguration configuration)
        {
            var output = new JsonPrefetchListPickerConfiguration();
