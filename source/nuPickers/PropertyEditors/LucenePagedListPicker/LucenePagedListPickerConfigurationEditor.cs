...
using nuPickers.PropertyEditors.JsonPagedListPicker;
using Umbraco.Core;
using Umbraco.Core.PropertyEditors;

namespace nuPickers.PropertyEditors.LucenePagedListPicker
{
    internal class LucenePagedListPickerConfigurationEditor : ConfigurationEditor<LucenePagedListPickerConfiguration>
    {
        public override Dictionary<string, object> ToConfigurationEditor(LucenePagedListPickerConfiguration configuration)
        {
        ...
        private class ItemValue
        {
          ...
          public override LucenePagedListPickerConfiguration FromConfigurationEditor(IDictionary<string, object> editorValues, LucenePagedListPickerConfiguration configuration)
        {
            var output = new LucenePagedListPickerConfiguration();
