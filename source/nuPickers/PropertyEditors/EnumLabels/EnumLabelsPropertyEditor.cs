namespace nuPickers.PropertyEditors.EnumLabels
{
    ...
    [DataEditor(PropertyEditorConstants.EnumLabelsAlias, "nuPickers: Enum Labels",
        EmbeddedResource.ROOT_URL + "Labels/LabelsEditor.html", ValueType = "TEXT")]
    ...
    [PropertyEditorAsset(ClientDependencyType.Javascript,
        EmbeddedResource.ROOT_URL + "Labels/LabelsEditorController.js" + EmbeddedResource.FILE_EXTENSION)]
