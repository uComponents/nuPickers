...
using nuPickers.PropertyEditors.JsonDropDownPicker;
using Umbraco.Core;
using Umbraco.Core.PropertyEditors;

namespace nuPickers.PropertyEditors.LuceneDropDownPicker
{
    internal class LuceneDropDownPickerConfigurationEditor : ConfigurationEditor<LuceneDropDownPickerConfiguration>
    {
        public override Dictionary<string, object> ToConfigurationEditor(LuceneDropDownPickerConfiguration configuration)
        {
        ...
        public override LuceneDropDownPickerConfiguration FromConfigurationEditor(IDictionary<string, object> editorValues,
            LuceneDropDownPickerConfiguration configuration)
        {
            var output = new LuceneDropDownPickerConfiguration();
