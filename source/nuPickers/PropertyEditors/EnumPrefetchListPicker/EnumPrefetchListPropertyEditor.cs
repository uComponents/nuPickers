namespace nuPickers.PropertyEditors.EnumPrefetchListPicker
{
    ...
    // EDITOR UI
    [PropertyEditor(PropertyEditorConstants.EnumPrefetchListPickerAlias, "nuPickers: Enum PrefetchList Picker", EmbeddedResource.RootUrlPrefixed + "PrefetchListPicker/PrefetchListPickerEditor.html", ValueType = "TEXT")]
    ...
    [PropertyEditorAsset(ClientDependencyType.Javascript, EmbeddedResource.RootUrlPrefixed + "EnumDataSource/EnumDataSourceConfigController.js.nu")]
