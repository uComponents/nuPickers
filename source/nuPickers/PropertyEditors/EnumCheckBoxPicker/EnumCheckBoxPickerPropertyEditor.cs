...
namespace nuPickers.PropertyEditors.EnumCheckBoxPicker
{
    ...
    // EDITOR UI
    [PropertyEditor(PropertyEditorConstants.EnumCheckBoxPickerAlias, "nuPickers: Enum CheckBox Picker", EmbeddedResource.RootUrl + "CheckBoxPicker/CheckBoxPickerEditor.html", ValueType = "TEXT")]
