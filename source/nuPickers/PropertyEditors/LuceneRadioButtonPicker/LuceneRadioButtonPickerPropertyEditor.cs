...
namespace nuPickers.PropertyEditors.LuceneRadioButtonPicker
{
    ...
    // EDITOR UI
    [PropertyEditor(PropertyEditorConstants.LuceneRadioButtonPickerAlias, "nuPickers: Lucene RadioButton Picker", EmbeddedResource.RootUrl + "RadioButtonPicker/RadioButtonPickerEditor.html", ValueType = "TEXT")]
