namespace nuPickers.PropertyEditors.DotNetTreePicker
{
    ...
    // EDITOR UI
    [PropertyEditor(PropertyEditorConstants.DotNetTreePickerAlias, "nuPickers: DotNet Tree Picker", EmbeddedResource.RootUrl + "TreePicker/TreePickerEditor.html", ValueType = "TEXT")]
    ...
    public class DotNetTreePickerPropertyEditor : BasePropertyEditor
    {
        protected override PreValueEditor CreatePreValueEditor()
        {
            return new DotNetTreePickerPreValueEditor();
        }
    }
}
