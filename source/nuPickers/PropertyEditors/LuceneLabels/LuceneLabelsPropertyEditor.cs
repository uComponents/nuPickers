namespace nuPickers.PropertyEditors.LuceneLabels
{
    ...
    // EDITOR UI
    [PropertyEditor(PropertyEditorConstants.LuceneLabelsAlias, "nuPickers: Lucene Labels", EmbeddedResource.RootUrlPrefixed + "Labels/LabelsEditor.html", ValueType = "TEXT")]
