...
using nuPickers.PropertyEditors.EnumCheckBoxPicker;
using Umbraco.Core;
using Umbraco.Core.PropertyEditors;

namespace nuPickers.PropertyEditors.DotNetCheckBoxPicker
{
    internal class DotNetCheckBoxPickerConfigurationEditor : ConfigurationEditor<DotNetCheckBoxPickerConfiguration>
    {
        public override Dictionary<string, object> ToConfigurationEditor(DotNetCheckBoxPickerConfiguration configuration)
        {
        ...
        public override DotNetCheckBoxPickerConfiguration FromConfigurationEditor(
            IDictionary<string, object> editorValues, DotNetCheckBoxPickerConfiguration configuration)
        {
            var output = new DotNetCheckBoxPickerConfiguration();
