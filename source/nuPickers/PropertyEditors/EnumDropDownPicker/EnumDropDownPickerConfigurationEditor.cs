...
namespace nuPickers.PropertyEditors.EnumDropDownPicker
{
    ...
    internal class EnumDropDownPickerConfigurationEditor : ConfigurationEditor<EnumDropDownPickerConfiguration>
    {
        public EnumDropDownPickerConfigurationEditor()
        {

        }
        public override Dictionary<string, object> ToConfigurationEditor(EnumDropDownPickerConfiguration configuration)
        {
        ...
        private class ItemValue
        {
          ...
          public override EnumDropDownPickerConfiguration FromConfigurationEditor(IDictionary<string, object> editorValues, EnumDropDownPickerConfiguration configuration)
        {
            var output = new EnumDropDownPickerConfiguration();
