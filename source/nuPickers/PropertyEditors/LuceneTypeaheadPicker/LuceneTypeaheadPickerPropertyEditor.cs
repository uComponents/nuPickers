namespace nuPickers.PropertyEditors.LuceneTypeaheadListPicker
{
    ...
    // EDITOR UI
    [PropertyEditor(PropertyEditorConstants.LuceneTypeaheadListPickerAlias, "nuPickers: Lucene TypeaheadList Picker", EmbeddedResource.ROOT_URL + "TypeaheadListPicker/TypeaheadListPickerEditor.html", ValueType = "TEXT")]
    ...
    [PropertyEditorAsset(ClientDependencyType.Javascript, EmbeddedResource.ROOT_URL + "TypeaheadListPicker/TypeaheadListPickerConfigController.js" + EmbeddedResource.FILE_EXTENSION)]
