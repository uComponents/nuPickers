...
{
    internal class JsonDropDownPickerConfigurationEditor : ConfigurationEditor<JsonDropDownPickerConfiguration>
    {
        public override Dictionary<string, object> ToConfigurationEditor(JsonDropDownPickerConfiguration configuration)
        {
        ...
        public override JsonDropDownPickerConfiguration FromConfigurationEditor(IDictionary<string, object> editorValues,
            JsonDropDownPickerConfiguration configuration)
        {
            var output = new JsonDropDownPickerConfiguration();
