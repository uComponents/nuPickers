...
{
    internal class LuceneTypeaheadListPickerConfigurationEditor : ConfigurationEditor<LuceneTypeaheadListPickerConfiguration>
    {
        public override Dictionary<string, object> ToConfigurationEditor(LuceneTypeaheadListPickerConfiguration configuration)
        {
        ...
        private class ItemValue
        {
          ...
          public override LuceneTypeaheadListPickerConfiguration FromConfigurationEditor(IDictionary<string, object> editorValues, LuceneTypeaheadListPickerConfiguration configuration)
        {
            var output = new LuceneTypeaheadListPickerConfiguration();
