...
{
    // EDITOR UI
    [DataEditor(PropertyEditorConstants.LucenePagedListPickerAlias, "nuPickers: Lucene PagedList Picker", EmbeddedResource.EmbeddedResource.ROOT_URL + "PagedListPicker/PagedListPickerEditor.html", ValueType = "TEXT")]
