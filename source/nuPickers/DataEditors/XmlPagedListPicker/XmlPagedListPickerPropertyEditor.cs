namespace nuPickers.DataEditors.XmlPagedListPicker
{
    ...
    // EDITOR UI
    [DataEditor(DataEditorConstants.XmlPagedListPickerAlias, "nuPickers: Xml PagedList Picker", EmbeddedResource.ROOT_URL + "PagedListPicker/PagedListPickerEditor.html", ValueType = "TEXT")]
    ...
    public class XmlPagedListPickerPropertyEditor : DataEditor
    {
        protected override PreValueEditor CreatePreValueEditor()
        {
            return new XmlPagedListPickerPreValueEditor();
        }
    }
}