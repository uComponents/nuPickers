...
using nuPickers.DataEditors.LuceneRadioButtonPicker;
using Umbraco.Core;
using Umbraco.Core.PropertyEditors;

namespace nuPickers.DataEditors.SqlRadioButtonPicker
{
    internal class SqlRadioButtonPickerConfigurationEditor : ConfigurationEditor<SqlRadioButtonPickerConfiguration>
    {
        public override Dictionary<string, object> ToConfigurationEditor(SqlRadioButtonPickerConfiguration configuration)
        {
        ...
        private class ItemValue
        {
          ...
          public override SqlRadioButtonPickerConfiguration FromConfigurationEditor(IDictionary<string, object> editorValues, SqlRadioButtonPickerConfiguration configuration)
        {
            var output = new SqlRadioButtonPickerConfiguration();
