...
{
    // EDITOR UI
    [DataEditor(DataEditorConstants.DotNetLabelsAlias, "nuPickers: DotNet Labels", EmbeddedResource.EmbeddedResource.ROOT_URL + "Labels/LabelsEditor.html", ValueType = "TEXT")]
