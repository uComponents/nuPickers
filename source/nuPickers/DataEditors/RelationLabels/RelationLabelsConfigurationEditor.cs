...
{
    internal class RelationLabelsConfigurationEditor : ConfigurationEditor<RelationLabelsConfiguration>
    {
        public override Dictionary<string, object> ToConfigurationEditor(RelationLabelsConfiguration configuration)
        {
        ...
        private class ItemValue
        {
          ...
          public override RelationLabelsConfiguration FromConfigurationEditor(IDictionary<string, object> editorValues, RelationLabelsConfiguration configuration)
        {
            var output = new RelationLabelsConfiguration();
