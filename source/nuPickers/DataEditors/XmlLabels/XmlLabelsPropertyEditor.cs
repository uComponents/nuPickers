namespace nuPickers.DataEditors.XmlLabels
{
    ...
    // EDITOR UI
    [DataEditor(DataEditorConstants.XmlLabelsAlias, "nuPickers: Xml Labels", EmbeddedResource.ROOT_URL + "Labels/LabelsEditor.html", ValueType = "TEXT")]
    ...
    public class XmlLabelsPropertyEditor : DataEditor
    {
