...
{
    internal class DotNetPrefetchListPickerConfigurationEditor : ConfigurationEditor<DotNetPrefetchListPickerConfiguration>
    {
        public override Dictionary<string, object> ToConfigurationEditor(DotNetPrefetchListPickerConfiguration configuration)
        {
        ...
        private class ItemValue
        {
          ...
          public override DotNetPrefetchListPickerConfiguration FromConfigurationEditor(IDictionary<string, object> editorValues, DotNetPrefetchListPickerConfiguration configuration)
        {
            var output = new DotNetPrefetchListPickerConfiguration();
