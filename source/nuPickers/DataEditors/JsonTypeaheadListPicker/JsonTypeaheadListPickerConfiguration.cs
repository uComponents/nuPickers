...
{
    internal class JsonTypeaheadListPickerConfiguration : ValueListConfiguration
    {
        ...
        [ConfigurationField("typeaheadListPicker", "Type a Head List Picker",
            EmbeddedResource.EmbeddedResource.ROOT_URL + "TypeaheadListPicker/TypeaheadListPickerConfig.html",
            HideLabel = true)]
