...
using nuPickers.DataEditors.DotNetRadioButtonPicker;
using Umbraco.Core;
using Umbraco.Core.PropertyEditors;

namespace nuPickers.DataEditors.JsonRadioButtonPicker
{
    internal class JsonRadioButtonPickerConfigurationEditor : ConfigurationEditor<JsonRadioButtonPickerConfiguration>
    {
        public override Dictionary<string, object> ToConfigurationEditor(JsonRadioButtonPickerConfiguration configuration)
        {
        ...
        private class ItemValue
        {
          ...
          public override JsonRadioButtonPickerConfiguration FromConfigurationEditor(IDictionary<string, object> editorValues, JsonRadioButtonPickerConfiguration configuration)
          {

            var output = new JsonRadioButtonPickerConfiguration();
