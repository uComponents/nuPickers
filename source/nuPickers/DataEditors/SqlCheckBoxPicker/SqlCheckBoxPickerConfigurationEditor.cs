...
using nuPickers.DataEditors.LuceneCheckBoxPicker;
using Umbraco.Core;
using Umbraco.Core.PropertyEditors;

namespace nuPickers.DataEditors.SqlCheckBoxPicker
{
    internal class SqlCheckBoxPickerConfigurationEditor : ConfigurationEditor<SqlCheckBoxPickerConfiguration>
    {
        public override Dictionary<string, object> ToConfigurationEditor(SqlCheckBoxPickerConfiguration configuration)
        {
        ...
        public override SqlCheckBoxPickerConfiguration FromConfigurationEditor(
            IDictionary<string, object> editorValues, SqlCheckBoxPickerConfiguration configuration)
        {
            var output = new SqlCheckBoxPickerConfiguration();
