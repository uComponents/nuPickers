...
{
    internal class LuceneRadioButtonPickerConfigurationEditor : ConfigurationEditor<LuceneRadioButtonPickerConfiguration>
    {
        public override Dictionary<string, object> ToConfigurationEditor(LuceneRadioButtonPickerConfiguration configuration)
        {
        ...
        private class ItemValue
        {
          ...
          public override LuceneRadioButtonPickerConfiguration FromConfigurationEditor(IDictionary<string, object> editorValues, LuceneRadioButtonPickerConfiguration configuration)
        {
            var output = new LuceneRadioButtonPickerConfiguration();
