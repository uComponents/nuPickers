...
using nuPickers.DataEditors.LuceneTypeaheadListPicker;
using Umbraco.Core;
using Umbraco.Core.PropertyEditors;

namespace nuPickers.DataEditors.SqlTypeaheadListPicker
{
    internal class SqlTypeaheadListPickerConfigurationEditor : ConfigurationEditor<SqlTypeaheadListPickerConfiguration>
    {
        public override Dictionary<string, object> ToConfigurationEditor(SqlTypeaheadListPickerConfiguration configuration)
        {
        ...
        private class ItemValue
        {
          ...
          public override SqlTypeaheadListPickerConfiguration FromConfigurationEditor(IDictionary<string, object> editorValues, SqlTypeaheadListPickerConfiguration configuration)
        {
            var output = new SqlTypeaheadListPickerConfiguration();
