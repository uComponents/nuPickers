...
{
    internal class SqlPagedListPickerConfigurationEditor : ConfigurationEditor<SqlPagedListPickerConfiguration>
    {
        public override Dictionary<string, object> ToConfigurationEditor(SqlPagedListPickerConfiguration configuration)
        {
        ...
        private class ItemValue
        {
          ...
          public override SqlPagedListPickerConfiguration FromConfigurationEditor(IDictionary<string, object> editorValues, SqlPagedListPickerConfiguration configuration)
        {
            var output = new SqlPagedListPickerConfiguration();
