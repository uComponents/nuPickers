...
using nuPickers.DataEditors.EnumRadioButtonPicker;
using Umbraco.Core;
using Umbraco.Core.PropertyEditors;

namespace nuPickers.DataEditors.DotNetRadioButtonPicker
{
    internal class DotNetRadioButtonPickerConfigurationEditor : ConfigurationEditor<DotNetRadioButtonPickerConfiguration>
    {
        public override Dictionary<string, object> ToConfigurationEditor(DotNetRadioButtonPickerConfiguration configuration)
        {
        ...
        private class ItemValue
        {
          ...
          public override DotNetRadioButtonPickerConfiguration FromConfigurationEditor(IDictionary<string, object> editorValues, DotNetRadioButtonPickerConfiguration configuration)
        {
            var output = new DotNetRadioButtonPickerConfiguration();
