...
{
    // EDITOR UI
    [DataEditor(DataEditorConstants.LucenePrefetchListPickerAlias, "nuPickers: Lucene PrefetchList Picker", EmbeddedResource.EmbeddedResource.ROOT_URL + "PrefetchListPicker/PrefetchListPickerEditor.html", ValueType = "TEXT")]
