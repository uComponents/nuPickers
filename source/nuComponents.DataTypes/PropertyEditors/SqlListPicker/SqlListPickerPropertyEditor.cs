...
namespace nuComponents.DataTypes.PropertyEditors.SqlListPicker
{
    ...
    // EDITOR UI
    [PropertyEditor("sqlListPicker", "nuComponents: Sql List Picker", EmbeddedResource.RootUrl + "ListPicker/ListPickerEditor.html", ValueType = "TEXT")]
    ...
    public class SqlListPickerPropertyEditor : BasePropertyEditor
    {
