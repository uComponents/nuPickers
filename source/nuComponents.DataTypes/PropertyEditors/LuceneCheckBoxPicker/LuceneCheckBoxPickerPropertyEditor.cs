namespace nuComponents.DataTypes.PropertyEditors.LuceneCheckBoxPicker
{
    ...
    // EDITOR UI
    [PropertyEditor(PropertyEditorConstants.LuceneCheckBoxPickerAlias, "nuComponents: Lucene CheckBox Picker", EmbeddedResource.RootUrl + "CheckBoxPicker/CheckBoxPickerEditor.html", ValueType = "TEXT")]
    ...
    public class LuceneCheckBoxPickerPropertyEditor : BasePropertyEditor
    {
