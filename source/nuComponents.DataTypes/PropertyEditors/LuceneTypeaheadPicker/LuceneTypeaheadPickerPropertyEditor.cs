...
namespace nuComponents.DataTypes.PropertyEditors.LuceneTypeaheadListPicker
{
    ...
    // EDITOR UI
    [PropertyEditor(PropertyEditorConstants.LuceneTypeaheadListPickerAlias, "nuComponents: Lucene TypeaheadList Picker", EmbeddedResource.RootUrl + "TypeaheadListPicker/TypeaheadListPickerEditor.html", ValueType = "TEXT")]
