...
namespace nuComponents.DataTypes.PropertyEditors.LuceneDropDownPicker
{
    ...
    // EDITOR UI
    [PropertyEditor(PropertyEditorConstants.LuceneDropDownPickerAlias, "nuComponents: Lucene DropDown Picker", EmbeddedResource.RootUrl + "DropDownPicker/DropDownPickerEditor.html", ValueType = "TEXT")]
