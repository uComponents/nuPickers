...
namespace nuComponents.DataTypes.PropertyEditors.LuceneRadioButtonPicker
{
    ...
    // EDITOR UI
    [PropertyEditor(PropertyEditorConstants.LuceneRadioButtonPickerAlias, "nuComponents: Lucene RadioButton Picker", EmbeddedResource.RootUrl + "RadioButtonPicker/RadioButtonPickerEditor.html", ValueType = "TEXT")]
